...
if("TRUE" STREQUAL "TRUE")
  set(apriltag_ros_SOURCE_PREFIX /home/zhongli/catkin_ws_aptg/src/apriltag_ros/apriltag_ros)
  set(apriltag_ros_DEVEL_PREFIX /home/zhongli/catkin_ws_aptg/devel/.private/apriltag_ros)
  ...
  set(apriltag_ros_INSTALL_PREFIX /home/zhongli/catkin_ws_aptg/install)
...
if(NOT "/home/zhongli/catkin_ws_aptg/devel/.private/apriltag_ros/include;/home/zhongli/catkin_ws_aptg/src/apriltag_ros/apriltag_ros/include;/usr/include/eigen3;/home/zhongli/catkin_ws_aptg/devel/include;/home/zhongli/catkin_ws_aptg/devel/include/apriltag;/usr/local/include/opencv4 " STREQUAL " ")
  set(apriltag_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/zhongli/catkin_ws_aptg/devel/.private/apriltag_ros/include;/home/zhongli/catkin_ws_aptg/src/apriltag_ros/apriltag_ros/include;/usr/include/eigen3;/home/zhongli/catkin_ws_aptg/devel/include;/home/zhongli/catkin_ws_aptg/devel/include/apriltag;/usr/local/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltag_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhongli/catkin_ws_aptg/src/apriltag_ros/apriltag_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(apriltag_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "apriltag_ros_common;apriltag_ros_continuous_detector;apriltag_ros_single_image_detector;-lpthread;m;/usr/local/lib/libopencv_calib3d.so.4.5.0;/usr/local/lib/libopencv_core.so.4.5.0;/usr/local/lib/libopencv_dnn.so.4.5.0;/usr/local/lib/libopencv_features2d.so.4.5.0;/usr/local/lib/libopencv_flann.so.4.5.0;/usr/local/lib/libopencv_gapi.so.4.5.0;/usr/local/lib/libopencv_highgui.so.4.5.0;/usr/local/lib/libopencv_imgcodecs.so.4.5.0;/usr/local/lib/libopencv_imgproc.so.4.5.0;/usr/local/lib/libopencv_ml.so.4.5.0;/usr/local/lib/libopencv_objdetect.so.4.5.0;/usr/local/lib/libopencv_photo.so.4.5.0;/usr/local/lib/libopencv_stitching.so.4.5.0;/usr/local/lib/libopencv_video.so.4.5.0;/usr/local/lib/libopencv_videoio.so.4.5.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhongli/catkin_ws_aptg/devel/.private/apriltag_ros/lib;/home/zhongli/catkin_ws_aptg/devel/lib;/home/zhongli/ego-planner/devel/lib;/opt/ros/melodic/lib)
